...
| 3 | Settings UI & Uploads | Extend SettingsOverlay with transition picker, overlay picker (built-in grid + custom upload), motion/size/opacity controls. User-uploaded PNG/GIF stored in IndexedDB overlays table. | COMPLETE | |
